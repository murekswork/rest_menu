...
class TestDishes:
    ...
    @pytest.mark.asyncio
    async def test_read_submenu_with_empty_dishes(self, client: AsyncClient, clean_tables, get_menu, get_submenu) -> None:
    ...
    @pytest.mark.asyncio
    async def test_create_dish(self, client: AsyncClient, get_menu, get_submenu):
    ...
    @pytest.mark.asyncio
    async def test_read_submenu_with_dishes(self, client: AsyncClient, get_menu, get_submenu):
        response = await client.get(f'/api/v1/menus/{get_menu}/submenus/{get_submenu}/dishes')
        assert response.status_code == 200
        assert response.json() != []
    ...
    async def test_read_submenu_without_dishes(self, clean_tables, client: AsyncClient, get_menu, get_submenu):
        ...
        response = await client.get(f'/api/v1/menus/{get_menu}/submenus/{get_submenu}/dishes/{str(dish_id)}')
        assert response.status_code == 200
    ...
    async def test_patch_dish(self, client: AsyncClient, clean_tables, get_menu, get_submenu):
        ...
        response = await client.get(f'/api/v1/menus/{get_menu}/submenus/{get_submenu}/dishes/{old_dish_id}')
        assert response.status_code == 200
        assert response.json()['title'] == 'title'
        assert response.json()['description'] == 'description'
        assert response.json()['price'] == '123.00'
        response = await client.patch(f'/api/v1/menus/{get_menu}/submenus/{get_submenu}/dishes/{old_dish_id}',
    ...
    async def test_put_dish(self, client: AsyncClient, clean_tables, get_menu, get_submenu):
        ...
        response = await client.get(f'/api/v1/menus/{get_menu}/submenus/{get_submenu}/dishes/{dish_id}')
        assert response.status_code == 200
        response = await client.delete(f'api/v1/menus/{get_menu}/submenus/{get_submenu}/dishes/{dish_id}')
        assert response.status_code == 200
        response = await client.get(f'/api/v1/menus/{get_menu}/submenus/{get_submenu}/dishes/{dish_id}')
